...
| `maxSameModelRetries` | 10 | Верхний лимит для повторных попыток на одной модели. |
...
| `modelRequestsPerMinute`| 10000 | Лимит для защиты от аномальных всплесков трафика. |
| `max_tokens` | 10000000 | Поддержка больших контекстов и длинных генераций. |
| `failureThreshold` | 50 | Лимит для Circuit Breaker. |
| `cooldownPeriodMins` | 10080 (1 неделя)| Максимальное время блокировки модели. |
