...
import { BaseProviderConfig } from '../../../../src/modules/providers/base.provider.js';
...
describe('DeepSeekProvider', () => {
    ...
    describe('chatCompletion', () => {
        ...
        it('should handle HTTP errors', async () => {
            ...
            await expect(provider.chatCompletion(mockRequest)).rejects.toThrow('DeepSeek API error: Internal Server Error');
        });
    });
});
